...
public class UpdateHandler
{
    ...
    public void Handle()
    {
        ...
        Console.WriteLine($"  Nombre: {dinosaur.Dino_name}");
        Console.WriteLine($"  Especie: {dinosaur.Dino_especie}");
        Console.WriteLine($"  Identificador (Username): {dinosaur.Sobre_nombre}");
        Console.WriteLine($"  Código de Registro (Email): {dinosaur.Register_code}");
        ...
        Console.WriteLine($"  Teléfono: {dinosaur.Phone ?? "No registrado"}");
        ...
        while (updating)
        {
            ...
            {
                case "1":
                    UpdateField(dinosaur, "Nombre", nameof(dinosaur.Dino_name));
                    break;
                case "2":
                    UpdateField(dinosaur, "Especie", nameof(dinosaur.Dino_especie));
                    break;
                case "3":
                    UpdateUniqueField(dinosaur, "Identificador (Username)", 
                        nameof(dinosaur.Sobre_nombre), isUsername: true);
                    break;
                case "4":
                    UpdateUniqueField(dinosaur, "Código de Registro (Email)", 
                        nameof(dinosaur.Register_code), isUsername: false);
                    break;
                case "5":
                    UpdateAge(dinosaur);
                    break;
                ...
                case "8":
                    ...
                    break;
                case "9":
                    UpdateField(dinosaur, "Teléfono", nameof(dinosaur.Phone), optional: true);
                    break;
                case "10":
    ...
    private void UpdateField(Dinosaur dinosaur, string fieldName, string propertyName, bool optional = false)
    {
        ...
        {
            nameof(dinosaur.Dino_name) => dinosaur.Dino_name,
            nameof(dinosaur.Dino_especie) => dinosaur.Dino_especie,
            ...
            nameof(dinosaur.Phone) => dinosaur.Phone ?? "[vacío]",
    ...
    private void UpdateUniqueField(Dinosaur dinosaur, string fieldName, string propertyName, bool isUsername)
    {
        string currentValue = propertyName switch
        {
            nameof(dinosaur.Sobre_nombre) => dinosaur.Sobre_nombre,
            nameof(dinosaur.Register_code) => dinosaur.Register_code,
            _ => "[desconocido]"
        };
